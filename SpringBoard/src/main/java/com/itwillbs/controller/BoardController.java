...
public class BoardController {
	...
	// 본문읽기GET : /board/read?bno=0&page=0&pageSize=0
	...
	@RequestMapping(value = "/modify",method = RequestMethod.POST)
	 public String modifyPOST(BoardVO vo, Model model, Criteria cri) throws Exception{
		logger.debug("/board/modify -> modifyPOST() 호출 ");
		logger.debug("cri : " + cri.getPage());
	...
	public String removePOST(@RequestParam("bno")int bno, Criteria cri) throws Exception {
	...
	// http://localhost:8088/board/listCri?page=3&pageSize=40
